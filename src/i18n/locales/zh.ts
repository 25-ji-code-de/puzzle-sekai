export const zh = {
  ...
  page: {
    ...
    keywords:
      "パズル⭐︎セカ,Puzzle SEKAI,拼图世界,世界计划,缤纷舞台,Project SEKAI,PJSK,プロセカ,初音未来,ミク,Miku,Vocaloid,虚拟歌手,消消乐,方块消除,拼图游戏,同人游戏,无尽模式,计时挑战,每日挑战,组合消除,Leo/need,MORE MORE JUMP,Vivid BAD SQUAD,Wonderlands×Showtime,25時、ナイトコードで。,25时,Nightcord,NeneRobo,Mikudayo,高分,浏览器游戏,PixiJS",
  },
  welcome: {
    title: "パズル⭐︎セカ",
  ...
  fun: {
    mikudayo: {
      ...
      subtitle: "「世界」的造访者",
      description:
        "Mikudayo 将作为特制的 2×2 巨型方块下落。该方块在判定时可视为任意「Miku」组合的一员。同时，当她被消除时，能将与之相邻的不同组合连带一起消除。",
    },
    kanadeSlow: {
      name: "奏明天空",
    ...
    truePhysics: {
      ...
      description:
        "完整刚体物理引擎（Rapier2D）。方块按质量、摩擦与力矩真实下落堆叠，允许结构倾倒、滑动与连锁崩塌；团消除改为接触近距判定，不再吸附格子。\n首次开启时会下载物理引擎包。与「悬臂翻转」互斥。\n\n「……牛顿先生，请对这个 SEKAI 温柔一点。」",
    },
  },
  inGame: {
    combo: "连击",
