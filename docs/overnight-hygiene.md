...
- `src/util/`: clamp (+atLeastOne, unitInterval, clampCount), color, pad, format, hash, date-key, css-class, dialog-class, dev-log, nearest, manhattan
...
Approximate suite size after session: ~552 tests / ~80 files (grows with util tests).
