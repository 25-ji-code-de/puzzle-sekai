...
- `src/util/`: clamp (+atLeastOne, unitInterval, clampCount), color, pad, format, hash, date-key, css-class, dialog-class, dev-log, nearest, manhattan, minmax, ease, json, number
