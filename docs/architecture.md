...
| Util         | `src/util/`                      | Shared pure helpers (clamp/color/pad/format/hash/date-key/css/dialog/dev-log/nearest/manhattan/minmax/ease/json/number) |
...
| `minmax.ts`       | `maxOf` / `minOf` array extremes                                                    |
